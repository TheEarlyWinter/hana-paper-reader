...
assert.match(panelSource, /UI_VERSION = "0\.4\.2"/);
...
assert.match(apiSource, /PLUGIN_API_VERSION = "0\.4\.2"/);
...
assert.match(read("routes/ui.js"), /ASSET_VERSION = "0\.4\.2"/);
assert.match(readme, /^# Hana Paper Reader 0\.4\.2/m);
...
assert.equal(publicSettings.apiVersion, "0.4.2");
